 ...
 * 
 * <p>
 * Description: This is the copy of maze class to for the testing purposes.
 * 
 * </p>
 * 
 * <p>
 * Copyright: Copyright © 2018 Lynn Robert Carter and Sawan
 * </p>
 * 
 * @author Lynn Robert Carter and Sawan
 * 

 * @version 1.00	25-10-2018 copy of maze class for testing purposes.
 * 
 */

public class Test_Maze extends Canvas {
	 ...
	 */
	public Test_Maze(double width, double height){
	...
	boolean makeMove(int r, int c) {
		...
		/** if we hit a wall or our path **/
		if (board[r][c]  == '|' || board[r][c]  == 'X'|| board[r][c]  == '-'|| board[r][c]  == '+') {
			return false;
		}
		...
		// Try to go Right
		result = makeMove(r, c+1);
		if (result==true) { return true;}
		
		// Try to go Up
		result = makeMove(r-1, c);
		if (result==true) { return true;}
		...
		else {board[r][c] = ' ';  }             // to mark it blank space after meeting a dead end
	 ...
	 * for the least number of visits. 
	 * 
	 ...
	 */
	public Test_Maze solveMaze(int r, int c){
		...
		Test_Maze solution = new Test_Maze(this);
